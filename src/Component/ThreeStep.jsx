        ...
        <div className=" bg-[#F9FAFC]">
            ...
            <div className='mt-[40px] grid grid-cols-3'>
                <div className='h-[380px] w-[380px] bg-white rounded-2xl px-3 pt-6'>
                    ...
                    <img src = {user} className='w-[45px] mt-[28px] bg-gradient-to-r from-[#4f39f63a] to-[#9614fa34] rounded-[50%] p-[10px] mx-auto' ></img>
                ...
                <div className='h-[380px] w-[380px] bg-white rounded-2xl px-3 pt-6'>
                    ...
                    <img src = {packagimg} className='w-[45px] mt-[28px] bg-gradient-to-r from-[#4f39f63a] to-[#9614fa34] rounded-[50%] p-[10px] mx-auto' ></img>
                ...
                <div className='h-[380px] w-[380px] bg-white rounded-2xl px-3 pt-6'>
                    ...
                    <img src = {rocket} className='w-[45px] mt-[28px] bg-gradient-to-r from-[#4f39f63a] to-[#9614fa34] rounded-[50%] p-[10px] mx-auto' ></img>
