...
const Nav = ({ carts }) => {
    return (
        <div className="border-b-2 border-gray-200">
           <div className="navbar bg-base-100 md:max-w-[1200px] mx-auto">
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost text-2xl font-bold text-[#4F39F6]">Digi<span className="ml-[-5px] text-[#9514FA]">Tools</span></a>
  </div>
